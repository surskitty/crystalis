...
; ================
	...
	db 59, ALAKAZAM, NO_ITEM
		db DISABLE
		db RECOVER
		db PSYCHIC_M
		db REFLECT

	db 61, RHYDON, NO_ITEM
		db FURY_ATTACK
		db SANDSTORM
		db ROCK_SLIDE
		db EARTHQUAKE
