...
MapGroup_Cinnabar:
	...
	map SeafoamIsland1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_AUTO, FISHGROUP_SEAFOAM
	map SeafoamIslandB1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SEAFOAM
	map SeafoamIslandB2F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SEAFOAM
	map SeafoamIslandB3F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SEAFOAM
	map SeafoamIslandB4F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SEAFOAM
