...
Kimono_girlNaokoScript:
	end_if_just_battled
	opentext
	writetext Kimono_girlNaokoAfterBattleText
	waitbutton
	closetext
	end
...
Kimono_girlNaokoAfterBattleText:
	text "I enjoyed that"
...
.PersonEvents:
	db 9
	person_event SPRITE_KIMONO_GIRL, 2, 0, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_TRAINER, 0, TrainerKimono_girlNaoko, -1
