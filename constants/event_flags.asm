...
; ???
        ...
        const EVENT_DARK_CAVE_ZAPDOS
        const EVENT_MT_MORTAR_MOLTRES
        const EVENT_MT_SILVER_MEWTWO
	const EVENT_SEAFOAM_ISLAND_1F_HYPER_POTION
	const EVENT_SEAFOAM_ISLAND_1F_WATER_STONE
	const EVENT_SEAFOAM_ISLAND_B1F_RARE_CANDY
	const EVENT_SEAFOAM_ISLAND_B1F_FULL_HEAL
	const EVENT_SEAFOAM_ISLAND_B3F_DRAGON_SCALE
	const EVENT_SEAFOAM_ISLAND_B3F_ELIXER
	const EVENT_SEAFOAM_ISLAND_B3F_NUGGET
	const EVENT_SEAFOAM_ISLAND_B3F_BRICK_PIECE
	const EVENT_SEAFOAM_ISLAND_B3F_REVIVE
	const EVENT_SEAFOAM_ISLAND_B3F_ESCAPE_ROPE
	const EVENT_SEAFOAM_ISLAND_B4F_BIG_PEARL
	const EVENT_SEAFOAM_ISLAND_B4F_BLIZZARD
	const EVENT_SEAFOAM_ISLAND_B4F_PEARL
	const EVENT_SEAFOAM_ISLAND_B4F_CARBOS
	const EVENT_SEAFOAM_ISLAND_B4F_KINGS_ROCK
	const EVENT_SEAFOAM_ISLAND_B4F_ICY_WIND
	const EVENT_119
	const EVENT_11A
	const EVENT_11B
	const EVENT_11C
...
; Blackbelt
	const EVENT_BEAT_BLACKBELT_KENJI_DUMMY1
	const EVENT_BEAT_BLACKBELT_YOSHI
	const EVENT_BEAT_BLACKBELT_KENJI_DUMMY2
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_TEACHER_MOLLY
	const EVENT_BEAT_TEACHER_TINA
	const EVENT_BEAT_MEDIUM_HOLLY
	const EVENT_BEAT_SKIER_KATHY
	const EVENT_BEAT_SKIER_LEXIE
	const EVENT_BEAT_BOARDER_CLAUDE
	const EVENT_BEAT_BIKER_DILLON
	const EVENT_BEAT_GUITARIST_BILLYJOE
	const EVENT_BEAT_BIKER_NICKY
	const EVENT_BEAT_KIMONOGIRL_ROXIE
	const EVENT_5DD
	const EVENT_5DE
	const EVENT_5DF
	const EVENT_5E0
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_TM_MOONBLAST
